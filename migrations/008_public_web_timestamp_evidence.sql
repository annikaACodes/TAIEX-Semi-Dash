...
RENAME TO company_monthly_report_dates_v7;
...
SELECT
    ...
    first_recorded_at_utc,
    updated_at_utc
FROM company_monthly_report_dates_v7;

DROP TABLE company_monthly_report_dates_v7;
...
CREATE TABLE company_monthly_publication_evidence (
    ...
    evidence_basis TEXT NOT NULL
        CHECK (evidence_basis IN ('cnyes_revenue_news')),
