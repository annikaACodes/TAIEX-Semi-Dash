...
DROP TRIGGER trim_company_monthly_publication_evidence_after_insert;
DROP INDEX idx_publication_evidence_company_month;

ALTER TABLE company_monthly_report_dates
RENAME TO company_monthly_report_dates_v9;
...
SELECT * FROM company_monthly_report_dates_v9;

DROP TABLE company_monthly_report_dates_v9;
...
RENAME TO company_monthly_publication_evidence_v9;
...
SELECT * FROM company_monthly_publication_evidence_v9;

DROP TABLE company_monthly_publication_evidence_v9;
